...
var EnhancedComponent = (0, _index2.default)({ elementResize: true })(MyComponent);
...
var Example = function (_React$Component2) {
  ...
  function Example() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Example)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this2), _this2.state = {
      right: 50
    }, _this2.handleButtonClick = function () {
      _this2.setState({
        right: _this2.state.right === 50 ? 200 : 50
      });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(EnhancedComponent, null)
        )
      );
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(Example, null), div);

},{"../index.jsx":2,"react":168,"react-dom":32}],2:[function(require,module,exports){
'use strict';
      ...
      _createClass(DimensionsHOC, [{
        ...
        value: function componentDidMount() {
          ...
          if (elementResize) {
            ...
            (0, _elementResizeEvent2.default)(this.refs.container, this.updateDimensions);
          } else {
...
},{"element-resize-event":3,"react":168}],3:[function(require,module,exports){
